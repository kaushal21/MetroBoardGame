...
public class CreatingBoard extends Application{
    ...
    void createBoard() throws FileNotFoundException {
        ...
        String cornerLocation = "src/metroGame/gui/assets/tile_back_cover.jpg";
        ...
        startLocation = 8;
        for(int i = 0; i < 8; i++) {
            String imageLocation = "src/metroGame/gui/assets/station" + (startLocation) + ".jpg";
        ...
        String centralLocation = "src/metroGame/gui/assets/centre_station.jpg";
    ...
    void updateBoard(String tile, int row, int col) throws FileNotFoundException {
        ...
        String tileLocation = "src/metroGame/gui/assets/"+tile+".jpg";
    ...
    public void draggable(ImageView tileView, Label labelText, String passedBy, int X, int Y) {
        ...
        tileView.setOnMouseReleased(event -> {
            ...
            String topLocation2 = "metroGame/gui/assets/" + tile + ".jpg";
